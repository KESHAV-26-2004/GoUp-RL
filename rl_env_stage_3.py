...
class GoUpEnv:
    ...
    def _generate_objects(self):
        ...
        # ============================================================
        # PLATFORM GENERATION : PHASE 3 TOWER
        # ============================================================
        ...
        # choose tower side
        # ------------------------------------------------------------
        tower_x = random.randint(
            MIN_X,
            MAX_X
        )


        # keep every platform same x
        # slightly randomize to avoid memorization
    ...
    def step(self, action):
        ...
        if self.steps >= 600 and not done:
