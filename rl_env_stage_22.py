...
FPS = 60
PLAYER_VEL = 6
TOTAL_PLATFORMS = 100          # <-- EXTENDED FROM 20 TO 25
...
class GoUpEnv:
    ...
    def _generate_objects(self):
        ...
        # ============================================================
        # FIRST CURRICULUM: REACHABLE RANDOM PLATFORMS
        # ============================================================
        ...
        for i in range(TOTAL_PLATFORMS):   # <-- USES THE NEW CONSTANT
    ...
    def reset(self, seed=None):
        ...
        self.final_platform_id = (
            self.platform_rows[-2]["platforms"][0]["id"]
        )
        ...
        self.max_blocks = TOTAL_PLATFORMS          # <-- SYNCED WITH CONSTANT
        self.block_gap = 192
        self.target_height = self.a_yaxis[TOTAL_PLATFORMS - 1]   # <-- SYNCED
    ...
    def step(self, action):
        ...
        if landed_platform_id is not None:
            ...
            if landed_platform_id not in self.visited_platform_ids:
                ...
                # near goal bonus
                if row_index >= TOTAL_PLATFORMS - 2:
        ...
        if self.steps >= 72*TOTAL_PLATFORMS and not done:
        ...
        if (
            self.player.jump_count == 0 and
            self.player.x_vel == 0 and
            jump == 0
        ):
            standing_penalty = -0.01
            reward += standing_penalty

        reward_breakdown["standing"] = standing_penalty
